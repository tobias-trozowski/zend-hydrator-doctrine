...
namespace Tobias\Zend\Hydrator\Doctrine;
...
class DoctrineHydrator extends AbstractHydrator
{
    /**
     * @var ObjectManager
     */
    ...
    public function setDefaultByValueStrategy(string $defaultByValueStrategy): DoctrineHydrator
    {
    ...
    public function setDefaultByReferenceStrategy(string $defaultByReferenceStrategy): DoctrineHydrator
    {
     ...
     *
     */
    protected function toMany(object $object, $collectionName, string $target, $values): void
    {
     ...
     * @return bool
     */
    private function isNullable($name): bool
    {

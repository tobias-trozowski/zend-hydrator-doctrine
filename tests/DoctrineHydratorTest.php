...
namespace TobiasTest\Zend\Hydrator\Doctrine;
...
use ReflectionClass;
use Tobias\Zend\Hydrator\Doctrine\DoctrineHydrator as DoctrineObjectHydrator;
use Tobias\Zend\Hydrator\Doctrine\Filter;
use Tobias\Zend\Hydrator\Doctrine\Strategy;
use TobiasTest\Zend\Hydrator\Doctrine\Asset\ByValueDifferentiatorEntity;
use TobiasTest\Zend\Hydrator\Doctrine\Asset\ContextStrategy;
use TobiasTest\Zend\Hydrator\Doctrine\Asset\NamingStrategyEntity;
use TobiasTest\Zend\Hydrator\Doctrine\Asset\SimpleEntity;
...
final class DoctrineHydratorTest extends TestCase
{
    ...
    /**
     * @var \Doctrine\Common\Persistence\Mapping\ClassMetadata|MockObject
     */
    protected $metadata;

    /**
     * @var \Doctrine\Common\Persistence\ObjectManager|MockObject
     */
    ...
    public function configureObjectManagerForOneToOneEntity()
    {
                ...
                $this->returnCallback(
                    function ($arg) {
                        if ($arg === 'id') {
                            ...
                            return Asset\ByValueDifferentiatorEntity::class;
                        }
                        throw new \InvalidArgumentException();
                    }
                )
        ...
        $this
            ...
            ->with('toOne')
            ->will($this->returnValue(Asset\ByValueDifferentiatorEntity::class));
        $this
            ->metadata
            ->expects($this->any())
            ->method('getReflectionClass')
    ...
    public function testCanHydrateSimpleEntityByValue()
    {
        ...
        $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $entity);
     ...
     * When using hydration by value, it will use the public API of the entity to set values (setters)
     *
     * @covers \Tobias\Zend\Hydrator\Doctrine\DoctrineObject::hydrateByValue
     */
     ...
     *
     * @covers \Tobias\Zend\Hydrator\Doctrine\DoctrineObject::hydrateByReference
     */
    ...
    public function testReuseExistingEntityIfDataArrayContainsIdentifier()
    {
        ...
        $this
            ...
            ->expects($this->once())
            ->method('find')
            ->with(Asset\ByValueDifferentiatorEntity::class, ['id' => 1])
    ...
    public function testReuseExistingEntityIfDataArrayContainsIdentifierWithZeroIdentifier()
    {
        ...
        $this
            ...
            ->expects($this->once())
            ->method('find')
            ->with(Asset\ByValueDifferentiatorEntity::class, ['id' => 0])
            ->will($this->returnValue($entityInDatabaseWithIdOfOne));
        $entity = $this->hydratorByValue->hydrate($data, $entity);
        $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $entity);
        $this->assertEquals('bar', $entity->getField(false));
    ...
    public function testExtractOneToOneAssociationByValue()
    {
        ...
        $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $data['toOne']);
    ...
    public function testHydrateOneToOneAssociationByValueUsingIdentifierForRelation()
    {
        ...
        $this
            ...
            ->expects($this->once())
            ->method('find')
            ->with(Asset\ByValueDifferentiatorEntity::class, 1)
            ->will($this->returnValue($entityInDatabaseWithIdOfOne));
        $entity = $this->hydratorByValue->hydrate($data, $entity);
        $this->assertInstanceOf(Asset\OneToOneEntity::class, $entity);
        $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $entity->getToOne(false));
    ...
    public function testHydrateOneToOneAssociationByValueUsingFullArrayForRelation()
    {
        ...
        $this
            ...
            ->method('find')
            ->with(
                Asset\ByValueDifferentiatorEntity::class,
                ['id' => 1]
            )
            ->will($this->returnValue($entityInDatabaseWithIdOfOne));
        $entity = $this->hydratorByValue->hydrate($data, $entity);
        $this->assertInstanceOf(
            Asset\OneToOneEntityNotNullable::class,
            $entity
        );
        $this->assertInstanceOf(
            Asset\ByValueDifferentiatorEntity::class,
    ...
    public function testHydrateOneToManyAssociationByValue()
    {
        ...
        foreach ($entities as $en) {
            $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $en);
    ...
    public function testHydrateOneToManyAssociationByValueUsingIdentifiersForRelations()
    {
        ...
        $entity = $this->hydratorByValue->hydrate($data, $entity);
        $this->assertInstanceOf(Asset\OneToManyEntity::class, $entity);
        /* @var $entity \TobiasTest\Zend\Hydrator\Doctrine\Asset\OneToManyEntity */
        $entities = $entity->getEntities(false);
        foreach ($entities as $en) {
            $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $en);
            $this->assertIsInt($en->getId());
    ...
    public function testHydrateOneToManyAssociationByReferenceWithArrayCausingDataModifications()
    {
        ...
        $reflSteps = [
            ...
            new ReflectionClass(Asset\ByValueDifferentiatorEntity::class),
            new ReflectionClass(Asset\ByValueDifferentiatorEntity::class),
            new ReflectionClass(Asset\OneToManyEntityWithEntities::class),
        ];
        $this
    ...
    public function testCanLookupsForEmptyIdentifiers()
    {
        ...
        $this
            ...
            ->expects($this->any())
            ->method('find')
            ->with(Asset\ByValueDifferentiatorEntity::class, '')
    ...
    public function testAssertNullValueNotUsedAsIdentifierForOneToOneWithNonOptionalMethodSignature()
    {
        ...
        $data = ['toOne' => null];
        $object = $this->hydratorByValue->hydrate($data, $entity);
        $this->assertInstanceOf(Asset\ByValueDifferentiatorEntity::class, $object->getToOne(false));
    }
    ...
    {
        $refl = new ReflectionClass(Asset\SimplePrivateEntity::class);
        $this
            ->metadata
            ->expects($this->any())
            ->method('getName')
            ->will($this->returnValue(Asset\SimplePrivateEntity::class));
        $this
            ->metadata
            ->expects($this->any())
            ->method('getAssociationNames')
    ...
    public function testCannotHydratePrivateByValue()
    {
        ...
        $this->assertInstanceOf(Asset\SimplePrivateEntity::class, $entity);
    }
    ...
    {
        $this->configureObjectManagerForOneToManyEntity();
        $this->hydratorByValue->setDefaultByValueStrategy(Asset\DifferentAllowRemoveByValue::class);
        $this->hydratorByReference->setDefaultByReferenceStrategy(Asset\DifferentAllowRemoveByReference::class);
        $entity = new Asset\OneToManyEntity();
        $this->hydratorByValue->hydrate([], $entity);
        $this->assertEquals(
            Asset\DifferentAllowRemoveByValue::class,
            $this->hydratorByValue->getDefaultByValueStrategy()
        );
        $this->assertInstanceOf(
            Asset\DifferentAllowRemoveByValue::class,
        ...
        $this->hydratorByReference->hydrate([], $entity);
        $this->assertEquals(
            Asset\DifferentAllowRemoveByReference::class,
            $this->hydratorByReference->getDefaultByReferenceStrategy()
        );
        $this->assertInstanceOf(
            Asset\DifferentAllowRemoveByReference::class,
